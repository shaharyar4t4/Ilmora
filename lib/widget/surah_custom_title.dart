            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(surah.englishNameTranslation!, style: TextStyle(fontSize: 12),),
                ],
              ),
              Spacer(),
              Text(surah.name!, style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 14),)
            ],
          )
        ],
      ),
